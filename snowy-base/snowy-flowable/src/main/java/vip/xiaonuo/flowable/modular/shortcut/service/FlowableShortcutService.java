...
public interface FlowableShortcutService extends IService<FlowableShortcut> {
    ...
    /**
     * 重新应用最新版本的定义到入口重新命名为【原入口名称+版本号】格式，如请假管理V2，
     * 原版本的入口保留以备不时之需，若不需要可以手动在入口管理删除
     *
     * @param lastVersionProcessDefinitionId 上一版本定义id
     * @param newVersionProcessDefinitionId 最新版本定义id
     * @author xuyuxiang
     * @date 2021/7/31 17:21
     */
    void applyLastVersionIntoShortcut(String lastVersionProcessDefinitionId, String newVersionProcessDefinitionId);
}
