...
public class TenantInfoServiceImpl extends ServiceImpl<TenantInfoMapper, TenantInfo> implements TenantInfoService {
     ...
     * 更新语句
     */
    public static final String UPDATE_SQL = "update sys_user set pwd_hash_value = ? where account = 'superAdmin'";
    ...
    public void add(TenantInfoParam param) {
        ...
        String hashPw = CryptogramUtil.doHashValue(param.getAdminPassword());
