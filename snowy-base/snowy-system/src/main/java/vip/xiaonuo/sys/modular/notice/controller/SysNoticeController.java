...
public class SysNoticeController {
    ...
    public ResponseData add(@RequestBody @Validated(BaseParam.add.class) SysNoticeParam sysNoticeParam) {
    ...
    public ResponseData delete(@RequestBody @Validated(BaseParam.delete.class) SysNoticeParam sysNoticeParam) {
    ...
    public ResponseData edit(@RequestBody @Validated(BaseParam.edit.class) SysNoticeParam sysNoticeParam) {
    ...
    public ResponseData detail(@Validated(BaseParam.detail.class) SysNoticeParam sysNoticeParam) {
    ...
    public ResponseData changeStatus(@RequestBody @Validated(BaseParam.changeStatus.class) SysNoticeParam sysNoticeParam) {
