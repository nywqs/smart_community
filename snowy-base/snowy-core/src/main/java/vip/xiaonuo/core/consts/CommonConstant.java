...
public interface CommonConstant {
    ...
    /**
     * flowable ACT_DE_MODEL 表名
     */
    String TABLE_NAME_ACT_DE_MODEL = "ACT_DE_MODEL";

    /**
     * flowable db 初始化完成标记编码
     */
    String FLOWABLE_DB_INITIALIZED_FLAG_NAME = "FLOWABLE_DB_INITIALIZED_FLAG";
