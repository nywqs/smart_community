 ...
 */
package vip.xiaonuo.modular.feedbackreply.enums;
...
public enum FeedbackReplyExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        FeedbackReplyExceptionEnum(Integer code, String message) {
        this.code = code;
