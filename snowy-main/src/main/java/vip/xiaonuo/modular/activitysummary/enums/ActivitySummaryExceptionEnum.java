 ...
 */
package vip.xiaonuo.modular.activitysummary.enums;
...
public enum ActivitySummaryExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        ActivitySummaryExceptionEnum(Integer code, String message) {
        this.code = code;
