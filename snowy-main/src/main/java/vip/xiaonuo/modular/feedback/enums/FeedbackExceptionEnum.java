 ...
 */
package vip.xiaonuo.modular.feedback.enums;
...
public enum FeedbackExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        FeedbackExceptionEnum(Integer code, String message) {
        this.code = code;
