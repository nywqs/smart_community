 ...
 */
package vip.xiaonuo.modular.article.param;
...
public class ArticleParam extends BaseParam {
     ...
     * 置顶
     */
    @NotNull(message = "置顶不能为空，请检查top参数", groups = {add.class, edit.class})
    private String top;

    /**
     * 热门
     */
    @NotNull(message = "热门不能为空，请检查hot参数", groups = {add.class, edit.class})
    private String hot;
