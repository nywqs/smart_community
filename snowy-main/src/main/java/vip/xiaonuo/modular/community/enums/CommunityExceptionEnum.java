 ...
 */
package vip.xiaonuo.modular.community.enums;
...
public enum CommunityExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        CommunityExceptionEnum(Integer code, String message) {
        this.code = code;
