 ...
 */
package vip.xiaonuo.modular.activityusers.enums;
...
public enum ActivityUsersExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        ActivityUsersExceptionEnum(Integer code, String message) {
        this.code = code;
