 ...
 */
package vip.xiaonuo.modular.video.enums;
...
public enum VideoExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        VideoExceptionEnum(Integer code, String message) {
        this.code = code;
