 ...
 */
package vip.xiaonuo.modular.merchant.enums;
...
public enum MerchantExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        MerchantExceptionEnum(Integer code, String message) {
        this.code = code;
