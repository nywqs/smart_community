 ...
 */
package vip.xiaonuo.modular.house.enums;
...
public enum HouseExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        HouseExceptionEnum(Integer code, String message) {
        this.code = code;
